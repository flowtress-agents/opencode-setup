 ...
 *
 * ADR 0001 (spec-2) + ADR 0002: a leaf sub-agent cannot promote itself to a
 * sub-orchestrator. The parent orchestrator must explicitly promote.
 * Sub-orchestrators live in additional tabs of the orchestrator's
 * workspace; max depth is 3 by default (orchestrator -> sub-orchestrator ->
 * sub-agent).
 *
